...
2. [`02-discover-v2.png`](02-discover-v2.png)：分类 Tab 直接置顶的发现页、排行榜和分类歌单；实现契约见 [`../DISCOVER_LAYOUT_SPEC.md`](../DISCOVER_LAYOUT_SPEC.md)。
3. [`03-search-results-v2.png`](03-search-results-v2.png)：从首页进入、不显示一级底部导航的独立搜索结果页；实现契约见 [`../SEARCH_LAYOUT_SPEC.md`](../SEARCH_LAYOUT_SPEC.md)。
...
5. [`05-playlist-detail.png`](05-playlist-detail.png)：歌单信息、播放操作和歌曲列表；实现契约见 [`../PLAYLIST_DETAIL_LAYOUT_SPEC.md`](../PLAYLIST_DETAIL_LAYOUT_SPEC.md)。
