...
fun LocalMusicEmptyScreenshot() {
    LocalMusicScreenshotContent(MoeKoeAppState())
}
...
fun LocalMusicContentScreenshot() {
    LocalMusicScreenshotContent(MoeKoeAppState(music = previewMusic))
}
...
@Composable
private fun LocalMusicScreenshotContent(state: MoeKoeAppState) {
